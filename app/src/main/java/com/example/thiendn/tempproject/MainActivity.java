...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textView = findViewById(R.id.tv_click_me);
        btnWatchMe = findViewById(R.id.btn_watch_movie);
        ...
        btnWatchMe.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
        ...
        btnWatchMe.setOnLongClickListener(new View.OnLongClickListener() {
            @Override
